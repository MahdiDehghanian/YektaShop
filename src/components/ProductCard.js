  ...
  return (
    ...
    >
      <Link to={`/productDetail/${id}`} >
        <div style={{
          background: 'white', height: '15rem', overflow: 'hidden',
      ...
      <Card.Body>
        ...
        <Button
          onClick={() => addToCart()}
          className={`${theme ? 'bg-dark-priamry text-black' : 'bg-light-primary'} d-flex align-item-center m-auto border-0`}
        >
